...
title = pygame.font.Font("./Minecraft.ttf", 50) # argumentos: tipo de letra y tamaño
score = pygame.font.Font("./Minecraft.ttf", 30)

sky = pygame.image.load("./cielo.png").convert() # directorio e imagen
player = pygame.image.load("./patoframe0.png").convert_alpha() # conversión para manejar los canales alfa
enemy = pygame.image.load("./frame1z.png").convert_alpha()
bullet = pygame.image.load("./bala.png").convert_alpha()
